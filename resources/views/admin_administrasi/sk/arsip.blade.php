...
<head>
    ...
    <title>Arsip SK - Admin Administrasi</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-edit { background: #f59e0b; color: white; padding: 5px 10px; border-radius: 6px; text-decoration: none; font-size: 11px; display: inline-block; }
        .btn-aktifkan { background: #10b981; color: white; padding: 5px 10px; border-radius: 6px; text-decoration: none; font-size: 11px; border: none; cursor: pointer; }
        .btn-delete { background: #ef4444; color: white; padding: 5px 10px; border-radius: 6px; text-decoration: none; font-size: 11px; border: none; cursor: pointer; }
        .btn-download { background: #3b82f6; color: white; padding: 5px 10px; border-radius: 6px; text-decoration: none; font-size: 11px; display: inline-block; }
    ...
    <div class="dashboard-wrapper">
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="{{ url('/admin_administrasi/sk/arsip') }}"><i class="fas fa-archive"></i> Arsip SK</a></li>
        ...
        <div class="main-content">
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-archive"></i> Arsip SK</h2>
                    <a href="{{ route('sk.index') }}" class="btn-primary"><i class="fas fa-arrow-left"></i> Kembali ke SK Aktif</a>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('sk.download', $item->id) }}" class="btn-download"><i class="fas fa-download"></i> Download</a>
                                </td>
                                <td>
                                    <form action="{{ route('sk.aktifkan', $item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="submit" class="btn-aktifkan" onclick="return confirm('Aktifkan SK ini?')"><i class="fas fa-undo"></i> Aktifkan</button>
                                    </form>
                                 </n>
                             </tr>
                            @empty
                            <tr>
                                <td colspan="6" style="text-align: center; padding: 40px;">
                                    <i class="fas fa-archive" style="font-size: 40px; color: #cbd5e1; display: block; margin-bottom: 10px;"></i>
                                    Belum ada SK di arsip
                                 </td>
                             </tr>
                            @endforelse
                        </tbody>
