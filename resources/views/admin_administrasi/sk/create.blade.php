...
<head>
    ...
    <title>Tambah SK - Admin Administrasi</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        label { font-weight: 600; font-size: 13px; display: block; margin-bottom: 6px; color: #1e293b; }
        ...
        .form-actions { display: flex; gap: 12px; margin-top: 25px; border-top: 1px solid #e9ecef; padding-top: 20px; }
        .btn-submit {
        ...
        <div class="main-content">
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-plus-circle"></i> Tambah SK</h2>
                </div>
                ...
                <form action="{{ route('sk.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_usulan" required>
                            ...
                            @foreach($usulan as $item)
                                <option value="{{ $item->id }}">{{ $item->pegawai->nama_lengkap }} - {{ $item->jenis_usulan }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nomor_sk" placeholder="Contoh: 800/001/BKPSDM/2026" required>
                        <small style="color:#64748b; font-size:11px;">Masukkan nomor SK sesuai format yang berlaku</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small style="color:#64748b; font-size:11px;">Upload file SK dalam format PDF (max 2MB)</small>
                    </div>

                    <div class="form-group">
                        <label>Keterangan (opsional)</label>
                        <textarea name="keterangan" rows="3" placeholder="Catatan tambahan jika ada..."></textarea>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('sk.index') }}" class="btn-back">
