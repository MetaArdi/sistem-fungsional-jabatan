...
<head>
    ...
    <title>Log Integrasi - Admin Administrasi</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sistem-imutasi { background: #f59e0b; color: white; }
        .sistem-bkn { background: #10b981; color: white; }
    ...
    <div class="dashboard-wrapper">
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="{{ url('/admin_administrasi/log-integrasi') }}"><i class="fas fa-exchange-alt"></i> Log Integrasi</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-exchange-alt"></i> Log Integrasi</h2>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->sk->nomor_sk ?? '-' }}</td>
                                <td>
                                    @php
                                        $sistem = '';
                                        if (str_contains($item->aksi, 'imutasi') || str_contains($item->aksi, 'i-mutasi')) {
                                            $sistem = 'I-MUTASI';
                                            $badgeClass = 'sistem-imutasi';
                                        } elseif (str_contains($item->aksi, 'bkn')) {
                                            $sistem = 'BKN';
                                            $badgeClass = 'sistem-bkn';
                                        } else {
                                            $sistem = ucfirst(str_replace('kirim_ke_', '', $item->aksi));
                                            $badgeClass = 'sistem-imutasi';
                                        }
                                    @endphp
                                    <span class="sistem-badge {{ $badgeClass }}">{{ $sistem }}</span>
                                 </n>
                                <td>
                            ...
                            <tr>
                                <td colspan="8" style="text-align: center; padding: 40px;">
                                    <i class="fas fa-exchange-alt" style="font-size: 40px; color: #cbd5e1; display: block; margin-bottom: 10px;"></i>
