    ...
    <div class="dashboard-wrapper">
        <div class="sidebar">
            <ul class="sidebar-menu">
                <li class="active"><a href="{{ url('/dashboard/verifikator') }}"><i class="fas fa-chart-line"></i> Dashboard</a></li>
        ...
        <div class="main-content">
            <div class="welcome-card">
                <div class="welcome-text">
                    ...
                    <p>Anda login sebagai Verifikator. Periksa dan verifikasi usulan kenaikan jabatan dari OPD.</p>
                    <span class="role-badge"><i class="fas fa-check-double"></i> Verifikator</span>
                </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-info">
                        <h3>{{ \App\Models\Usulan::whereIn('status', ['menunggu_verifikasi', 'sedang_diverifikasi'])->count() }}</h3>
                ...
                <div class="stat-card">
                    <div class="stat-info">
                        <h3>{{ \App\Models\Usulan::where('status', 'ditolak_verifikator')->count() }}</h3>
                        <p>Ditolak</p>
                    </div>
                ...
                <div class="stat-card">
                    <div class="stat-info">
                        ...
                        <p>Bahan Rapat Siap</p>
                    </div>
                    <div class="stat-icon"><i class="fas fa-file-alt"></i></div>
                </div>
                <div class="stat-card">
                    <div class="stat-info">
                        <h3>{{ \App\Models\Usulan::where('status', 'sk_diterbitkan')->count() }}</h3>
                        <p>SK Terbit</p>
                    </div>
            ...
            <div class="recent-card">
                <h3><i class="fas fa-clock"></i> Usulan Menunggu Verifikasi</h3>
                <ul class="activity-list">
                    @php
                        $usulanMenunggu = \App\Models\Usulan::with('pegawai')
                    ...
                    @forelse($usulanMenunggu as $item)
                    <li>
                        <div class="activity-icon"><i class="fas fa-user"></i></div>
                        <div class="activity-text">
                            <strong>{{ $item->pegawai->nama_lengkap ?? '-' }}</strong><br>
                            {{ $item->jabatan_lama }} → {{ $item->jabatan_baru ?? $item->unit_kerja_tujuan ?? 'Berhenti' }}
                        </div>
                    ...
                    <li>
                        ...
                        <div class="activity-text">Tidak ada usulan yang menunggu verifikasi</div>
