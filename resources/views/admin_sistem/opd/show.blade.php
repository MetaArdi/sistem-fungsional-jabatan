...
<head>
    ...
    <title>Detail OPD - Admin Sistem</title>
        ...
        <div class="main-content">
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-eye"></i> Detail OPD</h2>
                </div>
                ...
                <div class="detail-group">
                    ...
                    <p>{{ $opd->created_at ? $opd->created_at->format('d-m-Y H:i:s') : '-' }}</p>
                </div>

                <div class="detail-group">
                    <label>Terakhir diupdate</label>
                    <p>{{ $opd->updated_at ? $opd->updated_at->format('d-m-Y H:i:s') : '-' }}</p>
                </div>
