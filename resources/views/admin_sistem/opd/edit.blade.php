...
<head>
    ...
    <title>Edit OPD - Admin Sistem</title>
        ...
        <div class="main-content">
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-edit"></i> Edit OPD</h2>
                </div>
                ...
                <form method="POST" action="{{ route('opd.update', $opd->id_opd) }}">
                    ...
                    <div class="form-group">
                        <label>ID OPD</label>
                        <input type="text" name="id_opd" value="{{ $opd->id_opd }}" readonly style="background:#f0f0f0; cursor:not-allowed;">
                        <small>ID OPD tidak dapat diubah</small>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" rows="2">{{ old('alamat', $opd->alamat) }}</textarea>
                    </div>

                    <div class="form-group">
                        <label>Telepon</label>
                        <input type="text" name="telepon" value="{{ old('telepon', $opd->telepon) }}">
                    </div>
