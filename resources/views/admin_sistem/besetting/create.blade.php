...
<head>
    ...
    <title>Tambah Besetting JF - Admin Sistem</title>
        ...
        <div class="main-content">
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-plus"></i> Tambah Besetting JF</h2>
                </div>
                ...
                <form action="{{ route('besetting-jf.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-grid">
                        <div class="form-group full">
                            ...
                            <select name="opd_id" required>
                                ...
                                @foreach($opd as $item)
                                    <option value="{{ $item->id_opd }}" {{ old('opd_id') == $item->id_opd ? 'selected' : '' }}>
                                        {{ $item->nama_opd }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group full">
                            ...
                            <input type="text" name="jabatan_fungsional" value="{{ old('jabatan_fungsional') }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenjang" required>
                                ...
                                <option value="Pertama" {{ old('jenjang') == 'Pertama' ? 'selected' : '' }}>Pertama</option>
                                <option value="Muda" {{ old('jenjang') == 'Muda' ? 'selected' : '' }}>Muda</option>
                                <option value="Madya" {{ old('jenjang') == 'Madya' ? 'selected' : '' }}>Madya</option>
                                <option value="Utama" {{ old('jenjang') == 'Utama' ? 'selected' : '' }}>Utama</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="kebutuhan" value="{{ old('kebutuhan') }}" required>
                        </div>

                        <div class="form-group">
                            <label>Ketersediaan</label>
                            <input type="number" name="ketersediaan" value="{{ old('ketersediaan') }}" required>
                        </div>
                    </div>
