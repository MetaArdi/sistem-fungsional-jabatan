...
<head>
    ...
    <title>Edit Pegawai - Admin OPD</title>
        ...
        <div class="main-content">
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-edit"></i> Edit Data Induk Pegawai</h2>
                </div>
                ...
                <form method="POST" action="{{ route('pegawai.update', $pegawai->nip) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>NIP</label>
                            <input type="text" name="nip" value="{{ $pegawai->nip }}" readonly style="background:#f0f0f0; cursor:not-allowed;">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $pegawai->tempat_lahir) }}" required>
                        </div>
                        <div class="form-group">
                            <label>Tanggal Lahir <span style="color:red;">*</span></label>
                            <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $pegawai->tanggal_lahir) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="status_perkawinan" required>
                                ...
                                <option value="Cerai" {{ old('status_perkawinan', $pegawai->status_perkawinan) == 'Cerai' ? 'selected' : '' }}>Cerai</option>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" rows="2" required>{{ old('alamat', $pegawai->alamat) }}</textarea>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_sertifikat" value="{{ old('no_sertifikat', $pegawai->no_sertifikat) }}" placeholder="Contoh: REG-12345678">
                            <small>Nomor sertifikat uji kompetensi</small>
                        </div>
                        <div class="form-group">
                            <label>Masa Berlaku Sertifikat</label>
                            <input type="date" name="masa_berlaku_sertifikat" value="{{ old('masa_berlaku_sertifikat', $pegawai->masa_berlaku_sertifikat) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="tahun_predikat_kinerja" value="{{ old('tahun_predikat_kinerja', $pegawai->tahun_predikat_kinerja ?? date('Y') - 1) }}" placeholder="Contoh: 2025" min="2000" max="{{ date('Y') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="pangkat" required>
                                ...
                                <option value="Pengatur Muda" {{ old('pangkat', $pegawai->pangkat) == 'Pengatur Muda' ? 'selected' : '' }}>Pengatur Muda</option>
                                <option value="Pengatur Muda Tingkat I" {{ old('pangkat', $pegawai->pangkat) == 'Pengatur Muda Tingkat I' ? 'selected' : '' }}>Pengatur Muda Tingkat I</option>
                                ...
                                <option value="Penata" {{ old('pangkat', $pegawai->pangkat) == 'Penata' ? 'selected' : '' }}>Penata</option>
                                <option value="Penata Tingkat I" {{ old('pangkat', $pegawai->pangkat) == 'Penata Tingkat I' ? 'selected' : '' }}>Penata Tingkat I</option>
                                <option value="Pembina" {{ old('pangkat', $pegawai->pangkat) == 'Pembina' ? 'selected' : '' }}>Pembina</option>
                                <option value="Pembina Tingkat I" {{ old('pangkat', $pegawai->pangkat) == 'Pembina Tingkat I' ? 'selected' : '' }}>Pembina Tingkat I</option>
                                <option value="Pembina Utama Muda" {{ old('pangkat', $pegawai->pangkat) == 'Pembina Utama Muda' ? 'selected' : '' }}>Pembina Utama Muda</option>
                                <option value="Pembina Utama Madya" {{ old('pangkat', $pegawai->pangkat) == 'Pembina Utama Madya' ? 'selected' : '' }}>Pembina Utama Madya</option>
                                <option value="Pembina Utama" {{ old('pangkat', $pegawai->pangkat) == 'Pembina Utama' ? 'selected' : '' }}>Pembina Utama</option>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="tmt_pangkat" value="{{ old('tmt_pangkat', $pegawai->tmt_pangkat) }}" required>
                        </div>
                        <div class="form-group">
                            <label>Angka Kredit <span style="color:red;">*</span></label>
                            <input type="text" name="angka_kredit" value="{{ old('angka_kredit', $pegawai->angka_kredit) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="jabatan_saat_ini" value="{{ old('jabatan_saat_ini', $pegawai->jabatan_saat_ini) }}" required>
                        </div>
                        <div class="form-group">
                            <label>Unit Kerja <span style="color:red;">*</span></label>
                            <input type="text" name="unit_kerja" value="{{ old('unit_kerja', $pegawai->unit_kerja) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="usia_tahun" value="{{ old('usia_tahun', $pegawai->usia_tahun) }}" required>
                        </div>
                        <div class="form-group">
                            <label>Usia (Bulan) <span style="color:red;">*</span></label>
                            <input type="number" name="usia_bulan" value="{{ old('usia_bulan', $pegawai->usia_bulan) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jurusan" value="{{ old('jurusan', $pegawai->jurusan) }}" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label>Tahun Lulus <span style="color:red;">*</span></label>
                        <input type="number" name="tahun_lulus" value="{{ old('tahun_lulus', $pegawai->tahun_lulus) }}" required>
                    </div>
